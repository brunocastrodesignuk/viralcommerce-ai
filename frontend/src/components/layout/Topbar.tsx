  ...
  return (
    <header className="h-16 border-b flex items-center justify-between px-6 flex-shrink-0" style={{ backgroundColor: "var(--vc-card)", borderColor: "var(--vc-border)" }}>
      ...
      <div className="relative w-80">
        ...
        <input
          type="text"
          placeholder="Pesquisar produtos, campanhas..."
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-green-500/10 border border-green-500/20 rounded-lg">
          ...
          <span className="text-xs text-green-400 font-medium">Crawler ao vivo</span>
        </div>
          ...
          >
            ...
            {user && (
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-gray-500 leading-none mt-0.5 capitalize">Plano {user.plan}</p>
              </div>
            )}
          ...
          {menuOpen && (
            <div className="absolute right-0 top-full mt-2 w-52 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl py-1 z-50">
              ...
              <div className="px-4 py-2.5 border-b border-gray-800">
                ...
                <span className="text-xs font-semibold text-brand-400 capitalize">Plano {user?.plan}</span>
              </div>
